import { ArrowRight, BarChart3, MessageCircle, Users, Zap } from "lucide-react";
...
const features = [
  {
    ...
    description:
      "Manage all your WhatsApp conversations in one centralized place",
  },
  {
    icon: Zap,
    title: "Smart Automation",
    description:
      "Set up powerful workflows without writing a single line of code",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Gain deep insights into customer interactions and performance",
  },
];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="flex-1 bg-gradient-to-br from-slate-50 to-slate-100 py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto">
            Manage all your WhatsApp communications with our enterprise-grade
            CRM platform. Streamline workflows, enhance customer relationships,
      ...
      <footer className="bg-slate-900 text-slate-400 py-10 text-center">
        <p className="text-sm">© 2026 WhatsApp CRM. All rights reserved.</p>
      </footer>
    </div>
  );
}
