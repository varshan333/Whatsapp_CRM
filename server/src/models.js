...
const MessageSchema = new Schema({
  ...
  // full template object for template messages
  template: Schema.Types.Mixed,
  templateName: String,
  // providerMessageId stores the external provider's message id (e.g., WhatsApp message id)
  providerMessageId: { type: String, index: true },
  // include queued + attempts and lastError for outbound handling
  status: { type: String, enum: ['queued', 'sent', 'delivered', 'failed', 'read', 'unknown'], default: 'queued' },
