          ...
          <div className="hidden lg:block space-y-8">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  Manage all your WhatsApp communications in one powerful platform.
                  Streamline workflows, enhance customer relationships, and scale your
                  business with enterprise-grade automation.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-6">
                {[
                  { title: 'Unified Dashboard', desc: 'Monitor all conversations at a glance' },
                  { title: 'Smart Automation', desc: 'Set up workflows without any coding' },
                  { title: 'Team Collaboration', desc: 'Assign chats and manage your team' },
                  { title: 'Advanced Analytics', desc: 'Gain insights into customer interactions' },
                ].map((feature) => (
            ...
            <div className="pt-6 border-t border-slate-200">
              <p className="text-sm text-slate-500">
                Trusted by 500+ businesses worldwide to deliver exceptional customer experiences.
              </p>
            </div>
          </div>
